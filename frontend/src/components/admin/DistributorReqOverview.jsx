...
function DistributorReqOverview() {
  const { id } = useParams();
      ...
      axios
        ...
        .then((res) => {
          if (res.data.status) {
            ...
            navigate("/distributors_requests");
          }
        })
        .catch((err) => {
          if (!err.response.data.status) {
                  ...
                  <div className="card-body">
                    ...
                    <div className="row pb-5">
                      ...
                      <div className="col-md-3">
                        <button
                          onClick={() => handleAccept(`${distributorData.id}`)}
                      ...
                      <div className="col-md-3">
                        <button
                          onClick={() => handleReject(`${distributorData.id}`)}
...
export default DistributorReqOverview;
