                  ...
                  <div className="card-body">
                    ...
                    <div className="row pb-5">
                      ...
                      <div className="col-md-3">
                        <button
                          onClick={() => handleAccept(`${clientsData.id}`)}
                      ...
                      <div className="col-md-3">
                        <button
                          onClick={() => handleReject(`${clientsData.id}`)}
...
export default ClientReqOverview;
